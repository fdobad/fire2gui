...
from .Cell2Fire.Stats import Statistics
'''
...
class Cell2FireC:
    ...
    def run(self):
        ...
        c2fbinary = os.path.join(os.getcwd(),'Cell2FireC/Cell2Fire')
        if hasattr( self.args , 'plugin_dir' ):
            c2fbinary = os.path.join(self.args.plugin_dir,'Cell2FireC/Cell2Fire')
        if system() == 'Windows':
            c2fbinary += '.exe'
    ...
    def stats(self):
        # Get rows, cols 
        DFForest = read_csv(os.path.join(self.args.InFolder, "fuels.asc"), 
